...
function Element(label, type, value, id){
    ...
    this.Value = value !== null ? value : "No value";
...
var ElementList = {
   ...
   addElement: function(label, type, value){
        ...
        this.add(new Element(label, type, trueValue, this.LastId++));
        return this.Last;
    },
...
function loadAll(){
    if (Modernizr.localstorage){
        // on loadAll() we set lastId to 0 and give each eleemnt a new id starting at 0
